...
const UserManagement = () => {
    ...
    return (
        <div>
            ...
            <UsersModal isOpen={isUserModalOpen} toggleOpen={toggleUserModal} />
            <div
                className="px-6 w-[200px] py-3 mb-1 mr-1 text-sm font-bold text-white uppercase transition-all duration-150 ease-linear bg-pink-500 rounded shadow outline-none active:bg-pink-600 hover:shadow-lg focus:outline-none"
