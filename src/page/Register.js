        ...
        <Formik onSubmit={onSubmit} initialValues={initialValues} validationSchema={validationSchema}>
            {(formik) => (
                <div className="w-screen h-screen bg-blue-400">
                    <div className="flex flex-col items-center justify-center flex-1 h-full px-4 sm:px-3">
                        <div
                            className="w-full overflow-hidden text-gray-500 bg-gray-100 shadow-xl rounded-3xl"
                            style={{ maxWidth: 1000 }}
                        >
                                ...
                                <div className="w-full px-5 py-10 md:w-1/2 md:px-10">
                                    ...
                                    <Form>
                                        <div className="flex -mx-3">
                                            ...
                                            <div className="w-1/2 px-1 mb-5">
                                                <label className="px-1 text-xs font-semibold">Middle name</label>
                                                <div className="flex flex-col">
                                                    <Field
                                                        id="name_middle"
                                                        name="name_middle"
                                        ...
                                        <div className="flex -mx-3">
                                            <div className="w-1/2 px-1 mb-5">
                                                <label className="px-1 text-xs font-semibold">Username</label>
                                                <div className="flex flex-col">
                                                    <Field
                                                        id="username"
                                                        name="username"
                                        ...
                                        <div className="flex -mx-3">
                                            <div className="w-full px-1 mb-5">
                                                <button
                                                    type="submit"
                                                    className="block w-full max-w-xs px-1 py-3 mx-auto font-semibold text-white bg-indigo-500 rounded-lg hover:bg-indigo-700 focus:bg-indigo-700"
                                                >
                                                    REGISTER NOW
                                                </button>
                                            </div>
