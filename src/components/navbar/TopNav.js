...
const TopNav = ({ toggleNav }) => {
    ...
    const toggleProfile = (params) => {
        setIsProfOpen(!isProfOpen)
        console.log(isProfOpen)
    }

    return (
        <div className="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
            <div className="flex items-center">
                <button className="text-gray-500 focus:outline-none lg:hidden" onClick={toggleNav}>
            ...
            <div className="flex items-center">
                <div className="relative">
                    <button className="flex mx-4 text-gray-600 focus:outline-none" onClick={toggleNotification}>
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    {/* //TODO: OnClick Open the Notification */}
                    <div
                        className={`fixed inset-0 z-10 w-full h-full ${isNotifOpen ? "" : "hidden"}`}
                    ...
                    >
                        <div className="flex items-center px-4 py-3 -mx-2 text-gray-600 hover:text-white hover:bg-indigo-600">
                            <img
                ...
                <div className="relative">
                    ...
                    {/* //TODO: OnClick Open the Notification */}
                    <div
                        className={`fixed inset-0 z-10 w-full h-full ${isProfOpen ? "" : "hidden"}`}
                        onClick={toggleProfile}
                    />
                    <div
